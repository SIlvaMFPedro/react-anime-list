...
const TopNavigation = ({ index, setIndex}) => {
    ...
    return (
        <View style={{ ...styles.container, backgroundColor: darkTheme ? "#282C5" : "white"}}>
            {index === 0 ? (
                <TouchableOpacity onPress={() => setDarkTheme(!darkTheme)} style={styles.left}>
                    <Text style={{ ...styles.text, color: darkTheme ? "#f2f2f2" : "black"}}>
            ...
            {index ? (
                <TouchableOpacity style={styles.right} onPress={() => fetchTopAnime()}>
