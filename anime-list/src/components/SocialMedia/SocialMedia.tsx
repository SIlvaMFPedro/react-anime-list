// @ts-expect-error TS(2307): Cannot find module '../../assets/images/logo-linke... Remove this comment to see the full error message
import { ReactComponent as LinkedinLogo} from "../../assets/images/logo-linkedin.svg";
// @ts-expect-error TS(2307): Cannot find module '../../assets/images/logo-githu... Remove this comment to see the full error message
